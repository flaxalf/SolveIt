...
class MultiLevelFourFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_multi_level_four, container, false)
    ...
    private fun nextLevel(){
        val bundle = Bundle()
        bundle.putInt(Constants.LEVEL, 4) // Say to the dialog that fragment 1 called it
